...
<body>
    ...
    <div class="alert alert-success" role="alert"><span class="text-loja"><a class="btn btn-primary" role="button" id="btn_criarproduto" style="background: rgb(38,170,83);" onclick="$('#modal-criar').modal('show');">NOVO PRODUTO</a><strong>Área administrativa para gestão dos produtos</strong></span></div>
    <div id="items_loja">
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>Preço</th>
                        <th>Foto</th>
                        <th style="background: var(--bs-gray-300);">Funções</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.produtos.atualiza')}}">
                        ...
                        <div class="mb-3"><input id="prodpreco" class="form-control" type="text" name="up-preco" placeholder="Preço do produto"><small class="form-text text-danger"></small></div>
                        <div class="mb-3"><textarea id="proddesc" class="form-control" name="up-descricao" placeholder="Descrição do produto" rows="10" onkeydown="pulsar(event);"></textarea></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.produtos.novo')}}">
                        ...
                        <div class="mb-3"><input class="form-control" type="text" name="np-preco" placeholder="Preço do produto ( APENAS INTEIROS ou DECIMAIS )"><small class="form-text text-danger"></small></div>
                        <div class="mb-3"><textarea class="form-control" name="np-descricao" placeholder="Descrição do produto" rows="10" onkeydown="pulsar(event);"></textarea></div>
